...
WHERE events_calender.user_id = '{$_SESSION['login_id']}' order by events_calender.id desc ";
    ...
    <span style="font-size: 10px; color: black; padding: 5px; border-radius: 3px;">
        <b><?php echo $status_badge; ?></b>
                        ...
                        <!--        <option value="1" <?php echo ($event['status'] == 2) ? 'selected' : ''; ?>>Not Completed</option>-->
                        <!--        <option value="2" <?php echo ($event['status'] == 1) ? 'selected' : ''; ?>>Completed</option>-->
