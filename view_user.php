...
<?php
if(isset($_GET['id'])){
	$type_arr = array('',"Superdmin","User","Admin","Freelancer");
...
<div class="modal-footer display p-0 m-0">
        <a href="index2.php?page=user_list" type="button" class="btn btn-secondary" data-dismiss="modal">Back</a>
</div>
<style>
