    ...
    <div class="col-md-12">
      <div class="row ">
        <div class="justify-content-center ">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit your ticket</h5>
					...
					<?php if($_SESSION['login_type'] = 1): ?>
						<div class="form-group">
							...
							<select name="customer_id" id="customer_id" class="custom-select custom-select-sm select2">
								<option value=""></option>
							<?php
								$department = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM users order by concat(lastname,', ',firstname,' ',middlename) asc");
