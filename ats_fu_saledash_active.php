...
<main>
    <div class="pagetitle">
        <h1>My Active Candidate Tracking System</h1>
    </div>
    ...
    <div class="col-12">
        <div class="card sales-report overflow-auto">
            <div class="card-body">
                <h5 class="card-title">Pipeline Report : <a href ="saledashboardexcel.php">Print</a> </h5>
...
AND documents.user_id = '$_SESSION[login_id]' 
...
echo implode(',', $candidateRejectedData) . '</td>';
        ...
        echo '<td style="font-size:14px; text-align:center;">' . (isset($row['initialforecasted']) ? $row['initialforecasted'] : '0') . '</td>';
