              ...
              <form action="" id="job-management">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="jb_title" value="<?php echo isset($jb_title) ? $jb_title : '' ?>" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-6">
                ...
                <div class="row mb-3">
                       ...
                       <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" name="opencount" id="opencount" min="0" value="<?php echo isset($opencount) ? $opencount : '' ?>" required>
                        </div>
                        <div class="col-sm-6">
                        <label for="inputText" class="form-label"><span class="required">*</span>Initial Forecasted Counts</label>
                        <input type="number" class="form-control" name="initialforecasted" id="initialforecasted" min="0" value="<?php echo isset($initialforecasted) ? $initialforecasted : '' ?>" required>
                        </div>
                 </div>
                  <style>
                      .box
                ...
                <div class="row mb-3">
                  <div class="col-sm-12">
                    ...
                    <textarea class="form-control " name="jb_descrption" id="jb_descrption" value=" <?php echo isset($jb_descrption) ? $jb_descrption : '' ?>"  style="height: 300px">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="number" name="min_sal" class="form-control" value="<?php echo isset($min_sal) ? $min_sal : '' ?>" required>
                  </div>
                
               
                  <div class="col-sm-6">
                      <label for="inputNumber" class="form-label"><span class="required">*</span>Maximum Salary</label>
                    <input type="number" name="max_sal" class="form-control" value="<?php echo isset($max_sal) ? $max_sal : '' ?>" required>
                  </div>
                ...
                <div class="row mb-3">
                 ...
                 <label for="inputNumber" class="form-label">Deadline</label>
                    <input type="date" name="deadline" value="<?php echo isset($deadline) ? $deadline : '' ?>" class="form-control">
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <button form="job-management" class="btn btn-primary">Save</button>
                  </div>
                </div>
