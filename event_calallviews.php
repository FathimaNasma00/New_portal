...
<head>
    ...
    if (event.id) {  // Check if event.id is available
        window.location.href = './index2.php?page=event_edite&id=' + event.id;
    } else {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="eventpeo">
                    ...
                    <label for="statusNo">No</label> &nbsp; OR &nbsp;
