...
{
$id = $_POST["id"];
 $query = "SELECT sale_target.id,sale_target.candidate,sale_target.amount,sale_target.account_manger,sale_target.join_date,documents.id AS dmid,documents.ref_no,documents.title, documents.last_name,
 ...
 if(mysqli_num_rows($result) > 0)
 {
  ...
  header('Content-Disposition: attachment; filename=myhirings.xls');
  echo $output;
 }
}
?>