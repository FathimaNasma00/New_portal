...
<main>
  <div class="pagetitle">
      <h1>All Approved Documents</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index2.php">Home</a></li>
          <li class="breadcrumb-item">Documents</li>
          <li class="breadcrumb-item active">All Approved</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <table class="table table-borderless datatable">
					...
					$qry = $conn->query("SELECT * FROM documents where status=1 and accesby='{$_SESSION['login_id']}' order by unix_timestamp(date_created) desc");
