  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">My Rejectes</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                          ...
                          <div class="btn-group">
                           ...
                           <?php }else{ ?>
	                           <a href="./index.php?page=editreject_document&id=<?php echo $row['id'] ?>" target="_blank">
		                         ...
		                         &nbsp;
		                         <a onclick="return confirm('Are You Sure Want To Delete This Record!'); " href="delete_documet.php?deletemyrej_id=<?php echo $row['id'] ?>"><span class="badge bg-danger"><i class="bi bi-trash"></i> </span></a>
