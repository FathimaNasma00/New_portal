...
$qry = $conn->query("SELECT project_list.id,concat(users.firstname,' ',users.lastname) as name,project_list.rolname,project_list.start_date,project_list.end_date,project_list.user_ids,clintmanege.clint_name FROM `project_list`
                                            ...
                                            where project_list.id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	if($k == 'id')
		$k = 'ids';
	$$k = $v;
              ...
              <h5 class="card-title">Add Task</h5>
                		<div class="card-body">
                			<form action="" id="manage-task">
                			    <input type="hidden" name="id" value="<?php echo isset($ids) ? $ids : '' ?>">
                		<div class="row">
                			<div class="col-md-12">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <option selected value="<?php echo $clint_name; ?>"><?php echo $clint_name; ?></option>
                              	<?php 
                      ...
                      <?php endif; ?>
                				...
                				<div class="form-group">
                					 <label for="inputText" class="form-label"><span class="required">*</span> Role </label>
                                        <select class="form-control form-control-sm select2" required name="rolname">
                                            <option selected value="<?php echo $rolname; ?>"><?php echo $rolname; ?></option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                              ...
                              <option selected value="<?php echo $user_id; ?>"><?php echo $user_id; ?></option>
                              	<?php 
