    ...
    <div class="card card-outline card-primary">
        <div class="card-body">
              <div class="modal-body">
                            <label for="" class="control-label"><b>Payment Status <span style="font-size:11px;">(Select the Status Only)</span></b></label>
						      <select class="form-control form-control-sm select2" onchange="status_update(this.options[this.selectedIndex].value,'<?php echo $id; ?>')">  
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                         <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
                          <label for="" class="control-label"><b>Candidate <span style="font-size:11px;">(Name - Recruiter - RefNo)</span></b></label>
                    	...
                    	<div class="row">
    				    	<div class="col-md-12">
    						<div class="form-group">
    							<label for="" class="control-label"><b>Client</b></label>
					   ...
					   <div class="col-md-12">
						<div class="form-group">
							<label for="" class="control-label"><b>Account Manager</b></label>
		...
		$.ajax({
			...
			success:function(resp){
			     $('#add_data_Modal').modal('hide');  
					...
					setTimeout(function(){
						location.href = 'index2.php?page=listofsaletr'
					},1500)
