...
<body>
    ...
    function fetch_std() {
        $.ajax({
            url: "php/fetch_std.php",
            type: "post",
            dataType: "json",
            success: function(data) {
                var stdBody = "";
                for (var key in data) {
                    stdBody += `<option value="${data[key]['job']}">${data[key]['job']}</option>`;
                }
    ...
    function fetch_res() {
        $.ajax({
            url: "php/fetch_res.php",
            type: "post",
            dataType: "json",
            success: function(data) {
                var resBody = "";
                for (var key in data) {
                    resBody += `<option value="${data[key]['date']}">${data[key]['date']}</option>`;
                }
