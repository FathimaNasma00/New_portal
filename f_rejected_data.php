...
<?php 
    ...
    if(isset($_SESSION['dataadminstatusz']))
    {
        ?>
        <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
            <script>
        ...
        <?php 
        unset($_SESSION['dataadminstatusz']);
    }
...
<main>
  <div class="pagetitle">
      <h1>All Rejected Documents</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index2.php">Home</a></li>
          <li class="breadcrumb-item">Documents</li>
          <li class="breadcrumb-item active">All Rejectes</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <table class="table table-borderless datatable">
					...
					$qry = $conn->query("SELECT * FROM documents where status=2 AND accesby='{$_SESSION['login_id']}' order by unix_timestamp(date_created) desc");
					...
					<tr>
						...
						<td><b style="font-size:14px;"><a target="_blank" href="./index2.php?page=editreject_document&id=<?php echo $row['id']; ?>" class=""><?php echo ucwords($row['title']) ?> <?php echo ucwords($row['last_name']) ?></a></b></td>
						...
						<td class="text-center">
                          <div class="btn-group">
							 <?php if(($_SESSION['login_type'] == 4 ) AND ($row['status'] == 1) ){ ?>
		                        ...
		                        <a  href="./index2.php?page=editreject_document&id=<?php echo md5($row['id']) ?>"   target="_blank">
                           ...
                           <?php }else{ ?>
	                           <a href="./index.php?page=editreject_document&id=<?php echo $row['id'] ?>" target="_blank">
		                         <span class="badge bg-primary"><i class="bi bi-slash-square"></i></span>
		                        </a>
		                        </a>
		                         &nbsp;
		                         <a onclick="return confirm('Are You Sure Want To Delete This Record!'); " href="deleteadmindocuments.php?deletereject_id=<?php echo $row['id'] ?>"><span class="badge bg-danger"><i class="bi bi-trash"></i> </span></a>
