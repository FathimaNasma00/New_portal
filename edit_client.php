    ...
    <section class="section">
      ...
      <div class="row ">
        <div class="d-flex justify-content-center ">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Clint Information</h5>
                		<div class="card-body">

	                            <div class="card-header">
                                            		<div class="card-body">
                                            			<form action="" id="save_clint">
                                            				<input type="hidden" name="id" value="<?php echo isset($clint_id) ? $clint_id : '' ?>">
                                            				<div class="row">
                                            					<div class="col-md-12">
                                                                    	<div class="row mb-3">
				                                                    	<div class="col-sm-12">
                                            						...
                                            						<div class="form-group">
                                            							...
                                            							<input type="date" name="agend" class="form-control form-control-sm" required value="<?php echo isset($agend) ? $agend : '' ?>">
                                            						</div>
                                            							</div>
				                                                    </div>
