				...
				<tbody>
					...
					$qry = $conn->query("SELECT timetracker.`id`, 
                                        ...
                                        ON (`timetracker`.`user_id` = `users`.`id`) 
                                         where timetracker.log_id = '{$_SESSION['login_id']}'
                                        order by id desc");
					...
					<tr>
					   ...
					   <td class="text-left">
		                      ...
		                      <a onclick="return confirm('Are You Sure Want To Delete This Record!'); "  class="btn btn-danger btn-flat" href="timetrackerdelete.php?delete_id=<?php echo $row['id'] ?>" onclick="return confirm('Are You Sure Want To Edit This Record!'); ">
