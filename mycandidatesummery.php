  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">My Summary List</li>
        </ol>
      </nav>
    </div>
<div class="col-lg-12">
	<div class="card recent-sales overflow-auto">
		<div class="card-header">
		    <div class="row">
		        ...
		        <div class="col-2">
		          <form method="post" action="mycandidatesumexport.php">
		...
		<div class="card-body">
			<table class="table table-borderless datatable">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT documents.ref_no, documents.title, documents.last_name, clintmanege.clint_name,candidate_summery.feedback,documents.recruiter,candidate_summery.recuiter as rec, candidate_summery.id,candidate_summery.date,candidate_summery.application_id,
                    ...
                    WHERE candidate_summery.user_id = '{$_SESSION['login_id']}'
                    AND 
                    (documents.ref_no, clintmanege.clint_name, candidate_summery.recuiter, candidate_summery.date) IN (
