  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">My Approved</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <table class="table table-borderless datatable">
					...
					$qry = $conn->query("SELECT * FROM documents where user_id = '{$_SESSION['login_id']}'AND status=1 order by unix_timestamp(date_created) desc ");
                          ...
                          <div class="btn-group">
                           ...
                           <?php }else{ ?>
	                           <a href="./index.php?page=edit_document&id=<?php echo $row['id'] ?>" target="_blank">
		                         ...
		                         &nbsp;
		                         <a onclick="return confirm('Are You Sure Want To Delete This Record!'); " href="delete_documet.php?deletemyap_id=<?php echo $row['id'] ?>"><span class="badge bg-danger"><i class="bi bi-trash"></i> </span></a>
