    ...
    <section class="section">
      ...
      <div class="row ">
        <div class="justify-content-center ">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">All List OF Hiring</h5>
                		...
                		<div class="card-header">
                		    ...
                		    <div class="row">
                		        ...
                		        <div class="col-2">
                		          <form method="post" action="saletargetexport.php">
...
FROM 
  sale_target st
INNER JOIN documents d ON st.candidate = d.id
INNER JOIN users u ON st.user_id = u.id
INNER JOIN clintmanege cm ON st.client = cm.clint_id
LEFT JOIN (
    SELECT cs1.*
    FROM candidate_summery cs1
    INNER JOIN (
        SELECT application_id, MAX(id) AS max_id
        FROM candidate_summery
        GROUP BY application_id
    ) cs2 ON cs1.id = cs2.max_id
) cs ON st.candidate = cs.application_id
LEFT JOIN job_management jm ON cs.job_refno = jm.id
ORDER BY st.id DESC;
;
...
");
                					...
                					<tr>
                						...
                						<td class="text-center"><b><a href="./index2.php?page=view_documentz&id=<?php echo $row['dmid']; ?>" target="_blank"><?php echo $string ?></a></b></td>
