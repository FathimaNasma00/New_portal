 ...
 if(mysqli_num_rows($res1) > 0)
 {
     while($row = mysqli_fetch_array($res1))
  {
   ...
   <table class="table" bordered="1"> 
                    ...
                    <tr><th colspan="6" style="border-top: 2px solid black;border-bottom: 2px solid black;"><b> Total Count of CV Selected /Hired  '.$row["total_count"].' </b></th></tr>
    </table>           
  ';
  }
 ...
 if(mysqli_num_rows($res1) > 0)
 {
     while($row = mysqli_fetch_array($res1))
  {
   ...
   <table class="table" bordered="1"> 
                    ...
                    <tr><th colspan="6" style="border-top: 2px solid black;border-bottom: 2px solid black;"><b> Total Count of Rejected  '.$row["total_count"].' </b></th></tr>
    </table>           
  ';
  }
...
//   Cv Rejected
 ...
 if(mysqli_num_rows($result) > 0)
 {
  ...
  header('Content-Disposition: attachment; filename=ScreeningRatio.xls');
  echo $output;
 }
}
?>