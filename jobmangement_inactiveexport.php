...
{
 $query = "SELECT job_management.id,job_management.jb_ref,job_management.jb_title,job_management.jb_type,job_management.emp_type,job_management.jb_workingtype,
                   ...
                   job_management.deadline, concat(users.firstname,', ',users.middlename,' ',users.lastname) as name,clintmanege.clint_name,job_management.created_date  FROM job_management
