                ...
                <div class="card-body">
                  <table class="table table-borderless datatable">
					...
					<tr>
						...
						<td><b style="font-size:14px;"><a target="_blank" href="./index2.php?page=edit_document&id=<?php echo $row['id']; ?>" class=""><?php echo ucwords($row['title']) ?> <?php echo ucwords($row['last_name']) ?></a></b></td>
